...
import { Search, Github, Twitter, Layers, GraduationCap, Zap } from 'lucide-react';

const App: React.FC = () => {
  const [activeFilter, setActiveFilter] = useState<AreaOfStudy | 'all'>('all');
  const [activePage, setActivePage] = useState<'home' | 'about' | 'legal'>('home');
                ...
                <section className="bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800">
                  ...
                  <div className="flex gap-4">
                    <div className="bg-zinc-800 p-3 rounded-xl">
                       <p className="text-[10px] text-zinc-500 font-black uppercase mb-1">Source Code</p>
                       <p className="text-xs font-mono text-zinc-300">MIT LICENSE</p>
                    </div>
                    <div className="bg-zinc-800 p-3 rounded-xl">
                       <p className="text-[10px] text-zinc-500 font-black uppercase mb-1">Assets</p>
                       <p className="text-xs font-mono text-zinc-300">CC-BY-NC-4.0</p>
                    </div>
                  </div>
                </section>
              </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-zinc-500 text-[11px] max-w-md leading-relaxed">
                ...
                Built with precision, fueled by coffee and kinematic equations.
              </p>
            </div>
